...
function Footer() {
  return (
    <footer className="w-full h-screen px-12 py-[1.8rem] flex overflow-x-hidden pb-[10.5rem] rounded-t-[1.2rem]">
      ...
      <div className="w-1/2">
        <h1 className="text-[7.15rem] founder">PRESENTATIONS</h1>
        <div className="links neue flex flex-col gap-6 text-[14.7px]">
          <div className="links-1 w-12 flex flex-col gap-4">
            <p>S:</p>
          ...
          <div className="links-2-con flex justify-between -mb-6">
            <div className="links-2-left flex flex-col gap-4">
              <p>L:</p>
              <div className="flex flex-col">
                {[
                  "202-1965 W 4th Ave",
                  ...
                  <a href="#" key={index} className={`${index == 1 && "mb-4"}`}>
                    {link}
                  </a>
                ))}
              </div>
            </div>
            <div className="links-2-right w-[100px] flex flex-col gap-4">
              <p>M:</p>
              <div className="flex flex-col w-[4.3rem]">
                {[
                  "Home",
                  "Services",
                  "Our work",
          ...
          <div className="links-3 w-12 flex flex-col gap-4">
            <p>E:</p>
            <div className="flex flex-col">
              {["hello@ochi.design"].map((link, index) => (
                <a href="#" key={index}>
                  {link}
                </a>
              ))}
          ...
          <div className="links-4-con flex justify-between mt-[1.06rem] text-zinc-600">
            <p>
              © ochi design 2024. <a href="#">Legal Terms</a>
            </p>
            <p className="cursor-pointer">Website by Artorius</p>
          </div>
        </div>
      </div>
    </footer>
